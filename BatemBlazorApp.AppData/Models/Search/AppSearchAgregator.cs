...
{
    public class AppSearchAgregator
    {
        ...
        internal AppSearchAgregator(AppSearchModel searchModel)
        {
        ...
        static string[] GetWordsExclusions(AppSearchModel search)
        {
        ...
        internal static string[] GetPrefixesExclusions(AppSearchModel search)
        {
        ...
        internal static string[] GetPostfixesExclusions(AppSearchModel search)
        {
